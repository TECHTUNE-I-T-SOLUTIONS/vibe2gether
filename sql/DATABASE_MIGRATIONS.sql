...
CREATE TABLE IF NOT EXISTS public.featured_requests (
  ...
  type character varying(50) NOT NULL, -- 'Product', 'Service', 'Event'
...
-- Create indexes for featured_requests
...
CREATE TABLE IF NOT EXISTS public.admin_notifications (
  ...
  type character varying(50) NOT NULL, -- 'info', 'warning', 'success', 'error'
  title character varying(255) NOT NULL,
  message text,
  related_type character varying(50), -- 'post', 'report', 'user', 'featured_request'
  related_id uuid,
